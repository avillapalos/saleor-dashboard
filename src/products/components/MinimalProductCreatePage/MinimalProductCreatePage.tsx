...
import { MinimalProductDetailsForm } from "@dashboard/products/components/MinimalProductDetailsForm";
...
import MinimalProductCreateForm, {
  MinimalProductCreateData,
  MinimalProductCreateFormData,
  MinimalProductCreateHandlers,
} from "./form";

interface MinimalProductCreatePageProps {
  ...
  initial?: Partial<MinimalProductCreateFormData>;
  ...
  onSubmit?: (data: MinimalProductCreateData) => any;
  fetchMoreWarehouses: () => void;
  searchWarehousesResult: QueryResult<SearchWarehousesQuery>;
}

export const MinimalProductCreatePage: React.FC<MinimalProductCreatePageProps> = ({
  allChannelsCount,
  channelsErrors,
  currentChannels,
  loading,
  ...
  const handleAssignReferenceAttribute = (
    ...
    data: MinimalProductCreateData,
    handlers: MinimalProductCreateHandlers,
  ) => {
...
MinimalProductCreatePage.displayName = "MinimalProductCreatePage";
export default MinimalProductCreatePage;
