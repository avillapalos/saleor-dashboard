...
import { MinimalProductCreatePage } from "@dashboard/products/components/MinimalProductCreatePage";
import { ProductCreateData } from "@dashboard/products/components/ProductCreatePage";
import {
...
import { MINIMAL_PRODUCT_CREATE_FORM_ID } from "./consts";
...
export const ProductCreateView: React.FC<ProductCreateProps> = ({ params }) => {
  ...
  const [openModal, closeModal] = createDialogActionHandlers<
    ProductCreateUrlDialog,
    ProductCreateUrlQueryParams
  >(navigate, params => minimalProductAddUrl(params), params);
  const {
  ...
  const {
    ...
    {
      formId: MINIMAL_PRODUCT_CREATE_FORM_ID,
    },
  );
  ...
  return (
    <>
      ...
      <MinimalProductCreatePage
        initial={{
          taxClassId: taxClasses?.[0]?.id,
        }}
        ...
        onCloseDialog={currentParams => navigate(minimalProductAddUrl(currentParams))}
